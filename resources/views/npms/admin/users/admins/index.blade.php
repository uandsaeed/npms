...
@section('content_header')
    ...
    @component('npms.admin.components.bootstrap.breadcrumb')
        ...
        <li class="">
            <a href="{{ url('/admin/moderator/create') }}"><i class="fas fa-plus"></i> Create</a>
        </li>
    @endcomponent
@stop
                            ...
                            <td class="text-right">
                                <form action="{{ url("/admin/users/$item->id") }}" method="post">
                                    ...
                                    <div class="btn-group btn-group-xs">
                                        <a href="{{ url('/admin/moderator/edit/'.$item->id) }}"
                                           class="btn btn-flat btn-primary"><i class="fas fas-pencil"></i> Edit</a>
